...
class ResourceDataViewSectionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \Milestone\Appframe\Model\ResourceDataViewSection::query()
            ...
            ->create([	'id' => '330106', 	'resource_data' => '327105', 	'title' => 'Details', 			'colspan' => '12', 										])
            ->create([	'id' => '330107', 	'resource_data' => '327106', 		'title_field' => 'product.name', 		'colspan' => '12', 										])
            ->create([	'id' => '330108', 	'resource_data' => '327107', 				'colspan' => '9', 										])
            ->create([	'id' => '330109', 	'resource_data' => '327107', 	'title' => 'Progress', 			'colspan' => '3', 										])
        ;
