...
class ResourceDataViewSectionItemTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \Milestone\Appframe\Model\ResourceDataViewSectionItem::query()
            ...
            ->create([	'id' => '331133', 	'section' => '330109', 	'label' => 'Status', 	'attribute' => 'status', 												])
            ->create([	'id' => '331134', 	'section' => '330109', 	'label' => 'Description', 	'attribute' => 'description', 												])
            ->create([	'id' => '331135', 	'section' => '330110', 	'label' => 'Query 1', 	'attribute' => 'query1', 												])
            ->create([	'id' => '331136', 	'section' => '330110', 	'label' => 'Query 1 Props', 	'attribute' => 'query1_props', 												])
            ->create([	'id' => '331137', 	'section' => '330110', 	'label' => 'Query 2', 	'attribute' => 'query2', 												])
            ->create([	'id' => '331138', 	'section' => '330110', 	'label' => 'Query 2 Props', 	'attribute' => 'query2_props', 												])
            ->create([	'id' => '331139', 	'section' => '330110', 	'label' => 'Query 3', 	'attribute' => 'query3', 												])
            ->create([	'id' => '331140', 	'section' => '330110', 	'label' => 'Query 3 Props', 	'attribute' => 'query3_props', 												])
            ->create([	'id' => '331141', 	'section' => '330111', 	'label' => 'Header 1', 	'attribute' => 'header1', 												])
            ->create([	'id' => '331142', 	'section' => '330111', 	'label' => 'Header 2', 	'attribute' => 'header2', 												])
            ->create([	'id' => '331143', 	'section' => '330111', 	'label' => 'Header 3', 	'attribute' => 'header3', 												])
            ->create([	'id' => '331144', 	'section' => '330112', 	'label' => 'Footer 1', 	'attribute' => 'footer1', 												])
            ->create([	'id' => '331145', 	'section' => '330112', 	'label' => 'Footer 2', 	'attribute' => 'footer2', 												])
            ->create([	'id' => '331146', 	'section' => '330112', 	'label' => 'Footer 3', 	'attribute' => 'footer3', 												])
            ->create([	'id' => '331147', 	'section' => '330113', 		'attribute' => 'object', 												])
            ->create([	'id' => '331148', 	'section' => '330114', 		'attribute' => 'template', 												])
        ;
