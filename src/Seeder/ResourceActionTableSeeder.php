...
class ResourceActionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \Milestone\Appframe\Model\ResourceAction::query()
            ->create([	'id' => '332101', 	'resource' => '305117', 	'name' => 'ProductTransactionNewNature', 	'description' => 'Nature of the product in a transaction.. Fresh, Expired, Damaged etc', 			'menu' => 'New', 									])
            ->create([	'id' => '332102', 	'resource' => '305117', 	'name' => 'ProductTransactionViewNature', 	'description' => 'List all natures a product transaction havs', 			'menu' => 'List', 									])
            ->create([	'id' => '332103', 	'resource' => '305118', 	'name' => 'ProductTransactionNewType', 	'description' => 'Type of transaction like Loading, Unloading, Sales', 			'menu' => 'New', 									])
            ->create([	'id' => '332104', 	'resource' => '305118', 	'name' => 'ProductTransactionViewTypes', 	'description' => 'List all available types of product transaction', 			'menu' => 'List', 									])
            ->create([	'id' => '332105', 	'resource' => '305117', 	'name' => 'UpdateProductTransactionNature', 	'description' => 'Edit Nature details, change status', 	'title' => 'Update', 	'type' => 'primary', 										])
            ->create([	'id' => '332106', 	'resource' => '305118', 	'name' => 'UpdateProductTransactionType', 	'description' => 'Change type status, update name ', 	'title' => 'Update', 	'type' => 'primary', 										])
            ...
            ->create([	'id' => '332132', 	'resource' => '305109', 	'name' => 'AddProductImages', 	'description' => 'Action to add images to a product', 		'type' => 'primary', 	'menu' => 'Add New', 									])
            ->create([	'id' => '332133', 	'resource' => '305109', 	'name' => 'EditProductImages', 	'description' => 'Action to edit images to a product', 	'title' => 'Edit Details', 	'type' => 'primary', 										])
            ->create([	'id' => '332134', 	'resource' => '305109', 	'name' => 'ListProductImages', 	'description' => 'List all entries of product images', 			'menu' => 'List All', 									])
            ->create([	'id' => '332135', 	'resource' => '305109', 	'name' => 'ViewProductImage', 	'description' => 'View details of a product image entry', 	'title' => 'Details', 	'type' => 'primary', 										])
            ->create([	'id' => '332136', 	'resource' => '305128', 	'name' => 'ListReserves', 	'description' => 'List all reserve entries', 			'menu' => 'List All', 									])
            ->create([	'id' => '332137', 	'resource' => '305128', 	'name' => 'AddReserveEntry', 	'description' => 'Add new reserve details', 			'menu' => 'Add New', 									])
            ->create([	'id' => '332138', 	'resource' => '305128', 	'name' => 'ViewFnReserve', 	'description' => 'View details of reserve', 	'title' => 'Details', 	'type' => 'primary', 										])
            ->create([	'id' => '332139', 	'resource' => '305128', 	'name' => 'UpdateReserveAction', 	'description' => 'Update reserve details', 	'title' => 'Update', 	'type' => 'primary', 										])
            ->create([	'id' => '332140', 	'resource' => '305128', 	'name' => 'ListUncompletedReserves', 	'description' => 'List all uncompleted reserves', 			'menu' => 'Uncompleted', 									])
        ;
